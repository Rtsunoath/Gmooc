...
class CourseAdmin(object):
    list_display = ['name', 'desc', 'detail', 'course_org', 'learn_times', 'degree',
                    'add_time']
    search_type = ['name', 'desc', 'detail', 'course_org', 'learn_times', 'degree']
